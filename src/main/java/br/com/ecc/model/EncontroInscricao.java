...
@NamedQueries({
	...
	@NamedQuery(name="encontroInscricao.porEncontroHospedagemParticular", query="select u from EncontroInscricao u where u.encontro = :encontro and u.hospedagemParticular = true order by u.tipo"),
