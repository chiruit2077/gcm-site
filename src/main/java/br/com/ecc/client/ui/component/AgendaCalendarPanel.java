...
public class AgendaCalendarPanel extends FlowPanel {
	...
	public AgendaCalendarPanel() {
        ...
        layoutTable.getCellFormatter().setVerticalAlignment(0, 0,
                HasVerticalAlignment.ALIGN_TOP);
        layoutTable.getCellFormatter().setVerticalAlignment(1, 0,
                HasVerticalAlignment.ALIGN_TOP);
        layoutTable.getCellFormatter().setWidth(0, 0, "100%");
        add(layoutTable);
    ...
    private void configureCalendar() {
        ...
        ArrayList<Appointment> appts = AgendaBuilder.build();
...
//        multiDayAppt2.setMultiDay(true);
    ...
    private void configureViewsTabBar() {
        calendarViewsTabBar.addTab("Semana");
        calendarViewsTabBar.addTab("Mês");
        calendarViewsTabBar.selectTab(0);
        calendarViewsTabBar
