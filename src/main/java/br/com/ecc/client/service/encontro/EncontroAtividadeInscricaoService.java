...
public interface EncontroAtividadeInscricaoService extends RemoteService {
	...
	void salvaInscricoes(Encontro encontro, List<EncontroAtividadeInscricao> listaParticipantes, List<EncontroAtividadeInscricao> listaParticipantesOriginal) throws Exception;
