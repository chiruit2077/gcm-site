...
public interface EncontroAtividadeInscricaoServiceAsync {
	...
	void salvaInscricoes(Encontro encontro, List<EncontroAtividadeInscricao> listaParticipantes, List<EncontroAtividadeInscricao> listaParticipantesOriginal, AsyncCallback<Void> callback);
