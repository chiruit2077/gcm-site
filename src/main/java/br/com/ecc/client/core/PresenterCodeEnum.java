...
import br.com.ecc.client.ui.sistema.cadastro.OrganogramaLayoutPresenter;
...
import br.com.ecc.client.ui.sistema.caixa.CaixaPresenter;
...
import br.com.ecc.client.ui.sistema.secretaria.DocumentoPresenter;
...
public enum PresenterCodeEnum  {
	...
	ORGANOGRAMA_LAYOUT(2,28, OrganogramaLayoutPresenter.class, "Layout do Organograma", true),
